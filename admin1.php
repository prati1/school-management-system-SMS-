...
<head>
   ...
   // x.open("GET","deletestudent.php",true);
	...
	function delnews(student_id,first_name)
	{
	if (confirm("Are you sure you want to delete '" + first_name + "'"))
	{
	window.location.href = 'admin.php?delnews=' + student_id;
	}
	}
	</script>
...
*/
	...
	while($row = mysql_fetch_array( $result )) {
       ...
       //echo '<td><a href="javascript:delnews('$row->student_id','$row->first_name')">Delete</a></td>';
		//echo "<ul>n";
//echo "<li>$row->first_name <a href="javascript:delnews('$row->student_id','$row->first_name')">Delete</a></li>n";
//echo "</ul>n";
		echo "</tr>"; 
	} 
